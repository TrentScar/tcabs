...
<html lang="en">
  ...
  <body class="loggedin">
    ...
    <br>
    <p class="h4 mb-4 text-center">9. Review of unit</p>
    ...
    <body>
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
                  ...
                  <td><?php echo $row["CurrentBudg"]; ?></td>
                  <td><?php echo $row["Last_Meeting_Date"]; ?></td>
                </tr>
                <?php endwhile;?>
            </table>
            <br>
            <br>
            <div class="btn-group btn-group-justified">
              <a href="report9.php" class="btn btn-primary">Clear Search</a>
            </div>
        </form>
    </body>
  <?php
